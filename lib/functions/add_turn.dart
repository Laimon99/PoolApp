...
import 'package:pool_app/functions/pay.dart';
...
class AddTurn {
  ...
  static bool overlaps(DateTime startA, DateTime endA, DateTime startB,
      DateTime endB) {
...
// Funzione per aggiungere un turno
  static Future<void> add({
    ...
    if (selectedRole == null ||
        ...
        selectedEndTime == null || selectedPiscina == null) {
    ...
    try {
      ...
      final shiftData = {
        ...
        'pay': totalPay, // Salva la paga finale
      };
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Turno salvato con successo!')),
      );
